var callOnLoad = function(){
    $.each(exhibits, function(index, exhibit){
        var divs = []
        var container_div = "<div class='container ex'>"
        var row_div = "<div class='row'>"
        var result_div = "<div class='result'>"
        var info_div1 = "<div class='col-md-12 name'>"+ exhibit['exname'] +"</div>"
        console.log(exhibit['eximg'])
        var image_div = "<div class='col-md-12' class='image_div'><img class='center-block' src="+exhibit['eximg']+" alt='Responsive image' id='main_image'></img></div>"
